    ...
    <div class="flex-col flex md:gap-[100px]" id={id}>
      {places.map((place, index) => (
        <div
          ...
          id={`${id}-${index}`}
        >
          <Slider id="carouselCounter" class="carousel w-full max-md:gap-1 scroll-smooth duration-[8s] transition-transform ease-in-out">
          ...
          <div class="absolute top-0 w-full h-full z-10 left-0 pointer-events-none flex justify-center">
            ...
            <Slider.NextButton
              class={clx(
                ...
                "size-12 peer-disabled:size-auto",
                "bg-white peer-disabled:bg-transparent",
                ...
                "md:-translate-x-[24px] peer-disabled:-translate-x-[24px] md:-translate-y-1/2",
