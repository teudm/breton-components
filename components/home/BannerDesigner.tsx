...
function BannerDesigner(props: Banner) {
  ...
  return (
    <section class="BannerDesigner-slider relative container md:px-16 flex items-center md:mt-[150px] mt-[120px] flex-col" id="banner-designer">
      <div class="w-full">
        <div class="relative">
          <img
            src={imageLogo}
          ...
          >
            <Slider
              class={`carousel carousel-center gap-6 w-full h-full`}
            >
              {images?.map((img, index) => (
                <Slider.Item
                  index={index}
