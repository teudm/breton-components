...
function PageResult(props: SectionProps<typeof loader>) {
  ...
  return (
    <div class="grid grid-flow-row grid-cols-1 place-items-center">
      ...
      <div class={clx("pt-2 sm:pt-10 w-full mt-[50px]", "")}>
        {infinite
          ? (
            <div class="flex justify-center [&_section]:contents">
              <a
                rel="next"
                class={clx(
                  "btn btn-ghost border border-black",
    ...
    <>
      <div id={container} {...viewItemListEvent} class="w-full">
        {partial
          ? <PageResult {...props} />
          : (
            <div class="container flex flex-col gap-4 sm:gap-5 w-full py-4 sm:py-5">
              {device === "mobile" && (
                <Drawer
                  id={controls}
                  aside={
              ...
              <div class="flex flex-col">
                {device === "desktop" && (
                  <aside class="container place-self-start flex flex-col gap-9 mb-[50px]">
                    <span class="text-base font-semibold h-12 flex items-center hidden">
                      Filters
                    </span>
